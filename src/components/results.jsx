...
export default function Results({ loading, data }) {
  return (
    <div className="z-10 w-72 lg:w-auto bg-white flex flex-col lg:flex-row lg:justify-between absolute p-3 lg:p-6 -my-24 lg:-my-12 rounded-xl shadow-sm space-y-4 lg:space-y-0 lg:divide-x lg:divide-secondary">
